...
def create_character_api():
    ...
    character, err_msg, status_code = character_crud.create_character(
        name=character_data.name,
        bio=character_data.bio,
        image_url=(
            image_url
            if image and image.filename
            else character_data.image_url
        ),
...
def update_character_api(character_id):
    ...
    character, err_msg, status_code = character_crud.update_character(
        character_id,
        **update_data
    )
