...
const groups = [{ title: 'Discover', links: [['/', 'Home'], ['/explore', 'All discoveries'], ['/media', 'Multimedia center'], ['/characters', 'Character profiles'], ['/showcase', 'Merchandise showcase'], ['/releases', 'Release calendar'], ['/events', 'Events, calendar and map']] }, { title: 'Your workspace', links: [['/dashboard', 'Personal dashboard'], ['/collection', 'Bookmarks and private notes'], ['/profile', 'Profile and reading preferences'], ['/submit', 'Submit a fan story']] }, { title: 'Help and access', links: [['/assistant', 'Local discovery guide'], ['/feedback', 'Feedback and FAQs'], ['/privacy', 'Demo privacy information'], ['/login', 'Sign in'], ['/register', 'Register'], ['/forgot-password', 'Password reset'], ['/verify-email', 'Email verification handoff']] }, { title: 'Administration', links: [['/admin', 'Admin overview'], ['/admin?tab=content', 'Content and media'], ['/admin?tab=categories', 'Categories'], ['/admin?tab=events', 'Events'], ['/admin?tab=submissions', 'Fan review queue'], ['/admin?tab=users', 'User management'], ['/admin?tab=feedback', 'Feedback management'], ['/admin?tab=knowledge', 'Knowledge base']] }];
    ...
    if (mode === 'privacy')
        return React.createElement(React.Fragment, null,
            ...
            React.createElement("article", { className: "panel prose" },
                ...
                React.createElement("p", null, "Use Profile > Reset all demo data to remove Fan Hub Plus demo records from this browser. Theme and font preferences remain. Clearing site storage in your browser also removes them. Deleted content is removed from related local bookmarks, ratings and reading history."),
                ...
                React.createElement(Notice, null, "All fictional universes, illustrations, audio and event examples in this package are development fixtures. There is no store, payment gateway or real event ticket inventory.")));
