...
const date = (s, opts = { dateStyle: "medium" }) => new Intl.DateTimeFormat("en-GB", {
    ...opts,
...
export default function Events({ id }) {
    ...
    const locate = () => {
        ...
        navigator.geolocation.getCurrentPosition((p) => {
            ...
            setGeoBusy(false);
            update("city", "");
            notify("Events are sorted by distance. Your coordinates are not saved.", "info");
        }, (err) => {
            setGeoBusy(false);
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "event-toolbar" },
            ...
            React.createElement("div", { className: "segmented", role: "group", "aria-label": "Event view" }, [
                ["list", "list", "List"],
                ["calendar", "calendar", "Calendar"],
                ["map", "pin", "Map"],
            ].map(([v, icon, label]) => (React.createElement("button", { key: v, className: view === v ? "active" : "", "aria-pressed": view === v, onClick: () => setView(v) },
                React.createElement(Icon, { name: icon, size: 16 }),
                label))))),
        view === "list" &&
            (events.length ? (React.createElement("div", { className: "event-list" }, events.map((e) => (React.createElement("article", { className: "event-card", key: e.id },
        ...
        view === "calendar" && (React.createElement("div", { className: "calendar-panel" },
            React.createElement("div", { className: "calendar-header" },
                ...
                React.createElement("h2", null, new Intl.DateTimeFormat("en-GB", {
                    month: "long",
                    year: "numeric",
                    timeZone: "UTC",
                }).format(month)),
            ...
            React.createElement("div", { className: "calendar-grid" },
                ...
                Array.from({ length: days }, (_, i) => {
                    ...
                    return (React.createElement("div", { className: "calendar-day", key: key },
                        React.createElement("span", null, i + 1),
                        events
                            .filter((e) => new Intl.DateTimeFormat("en-CA", {
                            year: "numeric",
                            month: "2-digit",
                            day: "2-digit",
                            timeZone: "Asia/Ho_Chi_Minh",
                        }).format(new Date(e.startsAt)) === key)
                            .map((e) => (React.createElement(Link, { to: "/events/" + e.id, key: e.id }, e.title)))));
                })))),
