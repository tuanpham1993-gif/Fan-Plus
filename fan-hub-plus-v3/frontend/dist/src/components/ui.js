...
const paths = {
    chat: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M21 11a8 8 0 0 1-8 8H7l-5 3 2-6a8 8 0 1 1 17-5Z" }),
        React.createElement("path", { d: "M8 10h8m-8 4h5" }))),
    like: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M8 10 12 3c2 0 3 1 2 5h5c2 0 3 2 2 4l-2 7H8Z" }),
        React.createElement("path", { d: "M3 10h5v10H3Z" }))),
    flag: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M5 22V3c5-4 9 4 15 0v10c-6 4-10-4-15 0" }))),
    ticket: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M3 5h18v5a2 2 0 0 0 0 4v5H3v-5a2 2 0 0 0 0-4Z" }),
        React.createElement("path", { d: "M15 5v3m0 3v2m0 3v3" }))),
    expand: React.createElement("path", { d: "M4 9V4h5m6 0h5v5M4 15v5h5m6 0h5v-5" }),
    arrow: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M5 12h14m-6-6 6 6-6 6" }))),
    chevron: React.createElement("path", { d: "m9 5 7 7-7 7" }),
    ...
    sparkles: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "m12 3 2.4 6.6L21 12l-6.6 2.4L12 21l-2.4-6.6L3 12l6.6-2.4Z" }),
        React.createElement("path", { d: "m20 2 .7 2.3L23 5l-2.3.7L20 8l-.7-2.3L17 5l2.3-.7Z" }))),
    gamepad: (React.createElement(React.Fragment, null,
        ...
        React.createElement("path", { d: "M8 9v5m-2.5-2.5h5M16 10h.01M18 13h.01" }))),
    film: (React.createElement(React.Fragment, null,
    ...
    tv: (React.createElement(React.Fragment, null,
        ...
        React.createElement("path", { d: "m8 2 4 4 4-4M9 16h6" }))),
    music: (React.createElement(React.Fragment, null,
    ...
    bolt: React.createElement("path", { d: "m13 2-9 12h7l-1 8 10-13h-7Z" }),
    book: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M12 5v16M3 3c4-1 7 1 9 2 2-1 5-3 9-2v16c-4-1-7 1-9 2-2-1-5-3-9-2Z" }))),
    ...
    bookmark: React.createElement("path", { d: "M6 3h12v19l-6-4-6 4Z" }),
    sun: (React.createElement(React.Fragment, null,
        React.createElement("circle", { cx: "12", cy: "12", r: "4" }),
        React.createElement("path", { d: "M12 1v2m0 18v2M1 12h2m18 0h2M4 4l2 2m12 12 2 2M20 4l-2 2M6 18l-2 2" }))),
    moon: React.createElement("path", { d: "M21 13A9 9 0 0 1 11 3a9 9 0 1 0 10 10Z" }),
    menu: React.createElement("path", { d: "M4 6h16M4 12h16M4 18h16" }),
    close: React.createElement("path", { d: "m6 6 12 12M6 18 18 6" }),
    check: React.createElement("path", { d: "m4 12 5 5L20 6" }),
    play: React.createElement("path", { d: "m8 4 13 8-13 8Z" }),
    star: (React.createElement("path", { d: "m12 2 3 6.5 7 .8-5.1 5 1.3 7-6.2-3.5-6.2 3.5 1.3-7L2 9.3l7-.8Z" })),
    ...
    calendar: (React.createElement(React.Fragment, null,
        ...
        React.createElement("path", { d: "M7 2v6m10-6v6M3 11h18m-13 4h2m4 0h2m-8 4h2" }))),
    ...
    list: React.createElement("path", { d: "M8 5h13M8 12h13M8 19h13M3 5h.01M3 12h.01M3 19h.01" }),
    ...
    user: (React.createElement(React.Fragment, null,
        ...
        React.createElement("path", { d: "M4 22v-3a8 8 0 0 1 16 0v3" }))),
    ...
    shield: (React.createElement(React.Fragment, null,
        ...
        React.createElement("path", { d: "m8 12 3 3 5-6" }))),
    share: (React.createElement(React.Fragment, null,
        ...
        React.createElement("path", { d: "m8 11 8-5m-8 7 8 5" }))),
    edit: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "m14 5 5 5M4 20l5-1L21 7l-5-5L4 14Z" }))),
    trash: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M3 6h18M9 6V3h6v3M5 6l1 15h12l1-15M10 10v7m4-7v7" }))),
    plus: React.createElement("path", { d: "M12 4v16M4 12h16" }),
    mail: (React.createElement(React.Fragment, null,
        React.createElement("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2" }),
        React.createElement("path", { d: "m3 6 9 7 9-7" }))),
    lock: (React.createElement(React.Fragment, null,
        React.createElement("rect", { x: "5", y: "10", width: "14", height: "11", rx: "2" }),
        React.createElement("path", { d: "M8 10V6a4 4 0 0 1 8 0v4m-4 5v2" }))),
    logout: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M9 3H3v18h6m4-5 4-4-4-4m-5 4h14" }))),
    heart: (React.createElement("path", { d: "M12 21S1 14 2 7c1-6 8-6 10-1 2-5 9-5 10 1 1 7-10 14-10 14Z" })),
    info: (React.createElement(React.Fragment, null,
        React.createElement("circle", { cx: "12", cy: "12", r: "9" }),
        React.createElement("path", { d: "M12 11v6m0-10h.01" }))),
    external: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M14 3h7v7m0-7L11 13M10 3H3v18h18v-7" }))),
    download: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "M12 3v12m-5-5 5 5 5-5M3 16v5h18v-5" }))),
    send: (React.createElement(React.Fragment, null,
        React.createElement("path", { d: "m22 2-7 20-4-9-9-4Zm0 0L11 13" }))),
    ...
    bot: (React.createElement(React.Fragment, null,
        React.createElement("rect", { x: "4", y: "9", width: "16", height: "11", rx: "3" }),
        React.createElement("path", { d: "M12 9V5m0 0a1.6 1.6 0 1 0 0-3.2A1.6 1.6 0 0 0 12 5ZM2 13h2m16 0h2" }),
        React.createElement("circle", { cx: "9", cy: "14.5", r: "1.3", fill: "currentColor", stroke: "none" }),
        React.createElement("circle", { cx: "15", cy: "14.5", r: "1.3", fill: "currentColor", stroke: "none" }),
        React.createElement("path", { d: "M9.5 18h5" }))),
};
export function Icon({ name, size = 20, ...props }) {
    return (React.createElement("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", ...props }, paths[name] || paths.sparkles));
}
export function Button({ children, variant = "primary", busy = false, className = "", ...props }) {
    return (React.createElement("button", { type: "button", ...props, disabled: busy || props.disabled, className: `btn btn-${variant} ${className}`, "aria-busy": busy || undefined },
...
export function Skeleton({ cards = 3 }) {
    return (React.createElement("div", { className: "card-grid", "aria-label": "Loading content", "aria-busy": "true" }, Array.from({ length: cards }, (_, i) => (React.createElement("div", { key: i, className: "skeleton-card" },
...
export function BookmarkButton({ content, compact = true, }) {
    ...
    return (React.createElement("button", { type: "button", className: compact
            ? `card-bookmark ${saved ? "saved" : ""}`
            : `btn btn-${saved ? "primary" : "secondary"}`, disabled: busy, "aria-pressed": !!saved, "aria-label": `${saved ? "Remove bookmark" : "Bookmark"}: ${content.title}`, onClick: async () => {
            if (!user) {
...
export function ContentCard({ content, reason, }) {
    ...
    return (React.createElement("article", { className: "content-card", "data-testid": "content-card" },
        React.createElement("div", { className: "card-art" },
            React.createElement(Link, { to: "/content/" + content.id, tabIndex: -1, "aria-hidden": "true" },
                React.createElement("img", { src: content.image, alt: "", width: "640", height: "450", loading: "lazy", onError: (e) => {
                        e.currentTarget.onerror = null;
                        e.currentTarget.src = "/art/community.svg";
                    } })),
            React.createElement("span", { className: "type-badge" },
                React.createElement(Icon, { name: content.type === "video"
                        ? "play"
                        : content.type === "audio"
                            ? "music"
        ...
        React.createElement("div", { className: "card-body" },
            ...
            reason && (React.createElement("div", { className: "recommend-reason" },
                React.createElement(Icon, { name: "sparkles", size: 12 }),
                reason)))));
}
...
export function Notice({ children, kind = "info", }) {
    return (React.createElement("div", { className: `notice notice-${kind}` },
