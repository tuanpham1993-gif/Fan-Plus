...
export default function Layout({ children }) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        serverMode && user && user.verified === false && (React.createElement("div", { className: "demo-strip verify-strip" },
            React.createElement("span", null,
                React.createElement(Icon, { name: "info", size: 14 }),
                "Verify your email to post, comment or enter giveaways."),
            React.createElement(Link, { to: "/verify-email?email=" + encodeURIComponent(user.email) },
                "Verify now ",
                React.createElement(Icon, { name: "arrow", size: 12 })))),
